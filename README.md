...
实验室目前接收2025年入学的学术硕士研究生申请（博士研究生已定），计量心理学方向，优先考虑能熟练使用R或Python，有较好的微积分、线性代数、概率统计基础的候选人。也非常欢迎统计、数学、计算机等专业的学生加入。
...
**计量心理学**：发展针对追踪和密集追踪数据的统计模型，特别是动态结构方程模型和微分方程模型；探索多模态数据的挖掘、处理和预测。

**健康心理学**：从动态系统的视角解释人的健康行为过程，包括饮食、情绪、压力管理等；采用多模态机器学习对不健康行为做预测和预警。
