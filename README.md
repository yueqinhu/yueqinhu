...
研究聚焦于心理测量与统计模型的算法开发、以及在心理健康领域的应用，主要通过动态系统分析、机器学习、多模态识别等方法揭示个体维持健康行为、应对应激压力、罹患情绪障碍的预测因子和内在发生机制。
...
<p>
  <img width="300" align='center' src="https://github.com/yueqinhu/yueqinhu/blob/main/img/phone.png?raw=true">
</p>
