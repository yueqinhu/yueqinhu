...
✨ 祝贺李芮等关于机器学习评估主观幸福感预测因子相对重要性的论文在Journal of Happiness Studies发表！<br>
✨ 祝贺金卓然等关于压力观在疲惫感的压力动态模型中的作用的论文在Applied Psychology: Health and Well-Being发表！<br>
...
<p>
  <img width="700" align='center' src="https://github.com/yueqinhu/yueqinhu/blob/main/img/dynamicsystem.png?raw=true">
</p>
...
研究聚焦于心理测量与统计模型的算法开发，及其在心理健康领域的应用，主要通过密集追踪、动态系统分析、多模态评估、机器学习等方法揭示个体维持健康行为、应对应激压力、罹患情绪障碍的预测因子和内在发生机制。

**计量心理学**：发展针对追踪和密集追踪数据的统计模型；探索多模态数据的采集处理融合和解释方法。
...
<li>XXXX心理健康多维评估预警体系建设项目（2024-2025，公安部），主持</li>
...
<li>胡月琴，刘清山（2023）Python包：<a href="https://pypi.org/project/deFit/">deFit: Fitting Differential Equations to Time Series Data</a></li>
...
<li> 硕士生：宋欣竹、苗文、林园、顾雪怡、王舒婷、曹馨雅、关佳乐、袁铭瑞</li>
<li> 本科生：金卓然、于欣禾、王俊开</li>
<li> 旁听：武瑞娟、鲍璇</li>
</ul>
</details>
 <details>
...
<li>2021级本科生：胡骏焘、田汉庸、周逸然</li>
<li>2022级本科生：代泽西、金卓然、于欣禾、王俊开</li>
<li>2023级本科生：魏哲轩、陈旻恺、李司晨、梁语轩</li>
</ul>
</details> 
