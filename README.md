...
祝贺李芮等同学关于多模态情绪测量预测线上道德传染的论文在International Journal of Human-Computer Studies发表！
祝贺李明澜同学关于手机端智能信号预测短视频观看的论文在Computers in Human Behavior Reports发表！
祝贺刘文娟同学关于构建阅读障碍连续常模的论文在Assessment发表！
...
**计量心理学**：发展针对追踪和密集追踪数据的统计模型；探索多模态数据的处理挖掘融合和解释方法。
